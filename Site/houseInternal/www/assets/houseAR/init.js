...
function createUIElements() {
    ...
    var newMesh = new THREE.Mesh(new THREE.BoxBufferGeometry(100, 100, 100), new THREE.MeshBasicMaterial({
        color: '#00FF00'
    }));
...
function createRuler(dist) {
    ...
    var lineMtrX = new THREE.LineBasicMaterial({
        color: 0xffffff,
        linewidth: 3,
        opacity: 1
    });
    var lineMtrY = new THREE.LineBasicMaterial({
        color: 0x00ffff,
        linewidth: 3,
        opacity: 1
    });
    var lineMtrZ = new THREE.LineBasicMaterial({
        color: 0xffff00,
        linewidth: 3,
        opacity: 1
    });
    ...
    */
    ...
    for (var i = -dist; i < dist; i += 5) {
        ...
        if (i > 0) {
            ...
            var line = new THREE.Line(geo, lineMtrY);
            object.add(line);
            var textSprite = makeTextSprite((i).toString(), {
                r: 0,
                g: 40,
                b: 160,
                a: 255
            }, new THREE.Vector3(0.2, i, 3), Math.PI);
            ...
            var textSprite = makeTextSprite((i).toString(), {
                ...
                b: 255,
                a: 255
            }, new THREE.Vector3(i, 3, .2), Math.PI);
            object.add(textSprite);
            ...
            var textSprite = makeTextSprite((i).toString(), {
                ...
                b: 0,
                a: 255
            }, new THREE.Vector3(.2, 3, i), Math.PI);
            object.add(textSprite);
        } else {
            // lines on neg side
            var geo = new THREE.Geometry();
